namespace PE___AlgAnalysis
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            const int NumValues = 54; // Has to be at least 6 for the tests below to work.
            ...
            // - It slightly changes but not noticably, even when the number is incredibly large or just 1
            ...
            // - As the value of NumValues increases, the average time to find an index decreases
        }
    }
}
